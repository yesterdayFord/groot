...
The project copy is a portable snapshot. Groot remains the canonical source for reusable guidance.

## Copy Method

1. Choose the language base guide from `engineering/languages/<language>/base.md`.
2. Choose any explicitly applicable stricter or specialized profile from `engineering/languages/<language>/profiles/<profile>.md`.
3. Choose the applicable version delta from `engineering/languages/<language>/versions/<version>.md`.
...
Omit profile source lines when no profile applies.
